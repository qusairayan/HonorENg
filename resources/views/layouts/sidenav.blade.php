<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
    <div class="sidebar-inner px-2 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            <li class="nav-item" style="    background: #bebebe;
      padding: 0;
      margin: 0;">
            ...
            @if (auth()->user()->role == 'admin')
                ...
                <li class="nav-item {{ Request::segment(1) == 'engineers' ? 'active' : '' }}">
                  <a href="/engineers" class="nav-link">
                      <span class="sidebar-icon">
                          <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                              xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd"
              ...
              <li class="nav-item {{ Request::segment(1) == 'setting' ? 'active' : '' }}">
                <a href="/setting" class="nav-link">
                    ...
                    <span class="sidebar-text">الاأعدادات</span>
                </a>
            </li>
          ...
          @endif
            ...
            <li class="nav-item {{ Request::segment(2) == 'bookings' ? 'active' : '' }}">
              <a href="/engineer/bookings" class="nav-link">
                  <span class="sidebar-icon">
                      <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                          xmlns="http://www.w3.org/2000/svg">
                          <path fill-rule="evenodd"
