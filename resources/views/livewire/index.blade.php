...
<html lang="en">
	<head>
		...
		<link
			...
			type="image/png"
			sizes="56x56"
			href="/index/images/logo/logo (1).png" />
	...
	<body>
		<div class="main-page-wrapper">
			...
			<header class="theme-main-header">
				<div class="container">
					<a href="index.html" class="logo float-left tran4s"><img
							src="/index/images/logo/logo (1).png" alt="Logo"
							style="width: 25rem; height: 6rem;" /></a>
			...
			<div id="home" class="banner">
					...
					<div
						...
						<ul>
							...
							<li
								...
								data-thumb="/index/video/eng.mp4"
								data-rotate="0"
                ...
                /> -->
								...
								<div
									...
									data-videomp4="/index/video/eng.mp4"
								...
								<div
									...
									<a
										...
										class="project-button hvr-bounce-to-right">خدماتنا</a>
								</div>
							</li>
						...
						<div class="float-left">
							<div class="single-team-member">
								...
								<div class="member-name">
									...
									<ul>
										<li>
											<a href="#" class="tran3s round-border"><i class="fa fa-facebook"
													aria-hidden="true"></i></a>
										</li>
										<li>
											<a href="#" class="tran3s round-border"><i class="fa fa-twitter"
													aria-hidden="true"></i></a>
										</li>
										<li>
											<a href="#" class="tran3s round-border"><i class="fa fa-pinterest"
													aria-hidden="true"></i></a>
										</li>
										<li>
											<a href="#" class="tran3s round-border"><i class="fa fa-linkedin"
													aria-hidden="true"></i></a>
										</li>
									</ul>
								</div>
        ...
        // /.conatiner -->
			...
			============================================== -->
					...
					<script
						...
						src="/index/vendor/bootstrap/bootstrap.min.js"></script>
					...
					<script
						src="/index/vendor/revolution/jquery.themepunch.revolution.min.js"></script>
					<script
						type="text/javascript"
						src="/index/vendor/revolution/revolution.extension.slideanims.min.js"></script>
					<script
						type="text/javascript"
						src="/index/vendor/revolution/revolution.extension.layeranimation.min.js"></script>
					<script
						type="text/javascript"
						src="/index/vendor/revolution/revolution.extension.navigation.min.js"></script>
					<script
						type="text/javascript"
						src="/index/vendor/revolution/revolution.extension.kenburn.min.js"></script>
					<script
						type="text/javascript"
						src="/index/vendor/revolution/revolution.extension.actions.min.js"></script>
					<script
						type="text/javascript"
						src="/index/vendor/revolution/revolution.extension.video.min.js"></script>
					...
					<script
						type="text/javascript"
						src="/index/vendor/owl-carousel/owl.carousel.min.js"></script>
					<!-- mixitUp -->
					<script
						type="text/javascript"
						src="/index/vendor/jquery.mixitup.min.js"></script>
					<!-- Progress Bar js -->
					<script
						type="text/javascript"
						src="/index/vendor/skills-master/jquery.skills.js"></script>
					<!-- Validation -->
					<script
						type="text/javascript"
						src="/index/vendor/contact-form/validate.js"></script>
					<script
						type="text/javascript"
						src="/index/vendor/contact-form/jquery.form.js"></script>
...
<script>
    ...
    function initMap() {
		var mapOptions = {
										center: { lat:24.939760, lng: 46.708679 }, // Default: San Francisco
										zoom: 12,
									};
									...
									// Set marker position
									var markerPosition = { lat: 37.7749, lng: -122.4194 }; // Same as the initial center
